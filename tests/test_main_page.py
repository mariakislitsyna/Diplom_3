...
class TestMainPage:
    ...
    def test_redirection_to_order_list(self):
        main_page = MainPage()
    ...
    @allure.title('При нажатии на ингридиент всплывает окно с информацией')
    @allure.description('При нажатии на ингридиент всплывает модальное окно с информацией об ингридиенте')
    def test_popup_of_ingredient(self):
        main_page = MainPage()
    ...
    def test_close_ingredient_details_window(self):
        main_page = MainPage()
        main_page.click_on_ingredient()
    ...
    @allure.description('Проверяем что после добавления ингридиента счетчик увеличился')
    ...
    def test_successful_order(self, login):
        main_page = MainPage()
        main_page.add_filling_to_order()
